  ...
  return (
    <>
      <div className="flex-1">
        ...
        <article className="case-study p-8 text-slate-900">
          <h1 className={h1Style}>Projects</h1>
          <div className="max-w-5xl mx-auto">
            <section className="mb-10 p-8  rounded-3xl">
              <h1 className="inline-block text-4xl font-bold mb-4 p-10 rounded-[4rem] bg-blue-400 text-slate-100">
                Introduction
              </h1>
              <p>
            ...
            <section className="mb-10  p-8 rounded-3xl text-slate-800">
