export const h1Style =
  "sm:mb-6 text-5xl xl:text-[8rem] font-black text-yellow-300";
...
export const homeLinkStyle =
  "my-2 py-1 px-2 w-fit text-xs xl:text-xl text-blue-150 hover:text-white font-[400] sm:text-sm border-solid border-2 border-transparent rounded-md hover:bg-blue-950 hover:border-b-blue-600 transition-all xl:transtlate-y-[8px]";
